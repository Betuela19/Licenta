...
class LanguageAdapterHelp(private var mList: List<LanguageDataHelp>) :
    RecyclerView.Adapter<LanguageAdapterHelp.LanguageViewHolder>() {
    ...
    fun setFilteredList(mList: List<LanguageDataHelp>) {
        this.mList = mList
        notifyDataSetChanged()
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LanguageViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.each_item_help, parent, false)
